 ...
 */function ut(t){return pt({...t,state:!0,attribute:!1})}function _t(t){try{const e=new Date(t);if(isNaN(e.getTime()))return{date:null,time:null};const o=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0"),a=String(e.getHours()).padStart(2,"0");return{date:`${o}-${s}-${i}`,time:`${a}:${String(e.getMinutes()).padStart(2,"0")}`}}catch(e){return console.error("Date parsing error:",e,t),{date:null,time:null}}}function gt(t,e){if(e?.is_all_day||!1){const e=new Date,o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),s=Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate())-o,i=Math.round(s/864e5);return 0===i?"Today":-1===i?"Yesterday":1===i?"Tomorrow":i<-1?`${Math.abs(i)} days ago`:`In ${i} days`}const o=new Date;o.setHours(0,0,0,0);const s=new Date(t);s.setHours(0,0,0,0);const i=s.getTime()-o.getTime(),a=Math.round(i/864e5);if(0===a){return new Date(t).toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"})}return-1===a?"Yesterday":1===a?"Tomorrow":a<-1?`${Math.abs(a)} days ago`:`In ${a} days`}function ft(t){if(!t.due||"completed"===t.status)return!1;const e=t.is_all_day||!1,o=new Date(t.due);if(e){const t=new Date,e=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate());return Date.UTC(o.getUTCFullYear(),o.getUTCMonth(),o.getUTCDate())<e}{const t=new Date;return t.setHours(0,0,0,0),o.setHours(0,0,0,0),o<t}}function mt(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}function bt(t,e=!0,o){const s=t.attributes.chorebot_tasks||[],i=new Date;i.setHours(0,0,0,0);let a=s.filter(t=>{const o=!!t.due,s="completed"===t.status;if(!o)return e;const a=new Date(t.due);a.setHours(0,0,0,0);const r=mt(a,i),n=a<i;if(s&&t.last_completed){return!!mt(new Date(t.last_completed),new Date)}return!!r||!(!n||s)});if(o){const e=t.attributes.chorebot_sections||[],s=o,i=e.find(t=>t.name===s),r=i?i.id:s;a=a.filter(t=>t.section_id===r)}return a}function wt(t){const e=t.filter(t=>"completed"===t.status).length;return{completed:e,total:t.length}}function vt(t){const e=t.filter(t=>!!t.due),o=e.filter(t=>"completed"===t.status).length;return{completed:o,total:e.length}}function yt(t,e,o="Untagged",s="Upcoming"){return t.sort((t,i)=>{if(t.name===s)return 1;if(i.name===s)return-1;if(!e||0===e.length)return t.name===o?1:i.name===o?-1:t.name.localeCompare(i.name);const a=e.indexOf(t.name),r=e.indexOf(i.name);return-1!==a&&-1!==r?a-r:-1!==a?-1:-1!==r||t.name===o?1:i.name===o?-1:t.name.localeCompare(i.name)})}function kt(t,e,o=!1){const s=[],i=t.filter(t=>t.entity_id.startsWith("todo.chorebot_"));for(const t of i){const i=bt(t,o).filter(t=>t.computed_person_id===e);s.push(...i)}return s}function xt(t,e=!0,o=!1,s="Untagged",i="Upcoming",a,r){const n=t.attributes.chorebot_tasks||[],d=new Date;d.setHours(0,0,0,0);const c=new Date(d);c.setHours(23,59,59,999);const l=new Map,h=[];let p;if(a){const e=(t.attributes.chorebot_sections||[]).find(t=>t.name===a);p=e?e.id:a}for(const t of n){if(p&&t.section_id!==p)continue;if(r&&t.computed_person_id!==r)continue;const i=!!t.due,a="completed"===t.status;let n=!1,u=!1;if(i){if(t.due){const e=new Date(t.due);if(o&&e>c)u=!0;else{const o=new Date(e);o.setHours(0,0,0,0);const s=mt(o,d),i=o<d;a?t.last_completed&&mt(new Date(t.last_completed),new Date)&&(n=!0):(s||i)&&(n=!0)}}}else n=e;if(n){const e=t.tags||[];if(0===e.length)l.has(s)||l.set(s,[]),l.get(s).push(t);else for(const o of e)l.has(o)||l.set(o,[]),l.get(o).push(t)}else u&&h.push(t)}h.sort((t,e)=>new Date(t.due).getTime()-new Date(e.due).getTime());const u=Array.from(l.entries()).map(([t,e])=>({name:t,tasks:e,isCollapsed:!1}));return o&&h.length>0&&u.push({name:i,tasks:h,isCollapsed:!1}),u}function $t(t){if(!t||!t.has_recurrence)return null;const{recurrence_frequency:e,recurrence_interval:o,recurrence_byweekday:s,recurrence_bymonthday:i}=t;if(!e)return null;let a=`FREQ=${e};INTERVAL=${o||1}`;if("WEEKLY"===e&&s&&s.length>0)a+=`;BYDAY=${s.join(",").toUpperCase()}`;else if("MONTHLY"===e&&i){a+=`;BYMONTHDAY=${Math.max(1,Math.min(31,i))}`}return a}function Tt(t){const e=t.states["sensor.chorebot_points"],o=e?.attributes.points_display;return o?{icon:o.icon??"",text:o.text??"points"}:{icon:"",text:"points"}}function Ct(t){const e=Tt(t);return e.text?e.text.toLowerCase():""}function At(t,e){const o={...t,is_all_day:t.is_all_day||!1,tags:t.tags||[],section_id:t.section_id,points_value:t.points_value||0,streak_bonus_points:t.streak_bonus_points||0,streak_bonus_interval:t.streak_bonus_interval||0};if(t.due){const e=_t(t.due);o.due_date=e.date??void 0,o.due_time=e.time??void 0,o.has_due_date=!0}else o.has_due_date=!1;let s=t.rrule;if(t.parent_uid&&e){const i=e.find(e=>e.uid===t.parent_uid);i&&(s=i.rrule,o.streak_bonus_points=i.streak_bonus_points||0,o.streak_bonus_interval=i.streak_bonus_interval||0)}const i=function(t){if(!t)return null;try{const e=t.split(";");let o=null,s=1;const i=[];let a=null;for(const t of e){const[e,r]=t.split("=");if("FREQ"===e)"DAILY"!==r&&"WEEKLY"!==r&&"MONTHLY"!==r||(o=r);else if("INTERVAL"===e){const t=parseInt(r,10);!isNaN(t)&&t>0&&(s=t)}else if("BYDAY"===e)i.push(...r.split(","));else if("BYMONTHDAY"===e){const t=parseInt(r,10);!isNaN(t)&&t>=1&&t<=31&&(a=t)}}return o?{frequency:o,interval:s,byweekday:i,bymonthday:a}:null}catch(e){return console.error("rrule parsing error:",e,t),null}}(s);return i?(o.has_recurrence=!0,o.recurrence_frequency=i.frequency,o.recurrence_interval=i.interval,o.recurrence_byweekday=i.byweekday,o.recurrence_bymonthday=i.bymonthday||1):(o.has_recurrence=!1,o.recurrence_frequency="DAILY",o.recurrence_interval=1,o.recurrence_byweekday=[],o.recurrence_bymonthday=1),o}function St(t){const e=function(t){const e=Tt(t);return e.text?e.text.charAt(0).toUpperCase()+e.text.slice(1):""}(t)||"Points";return function(t){return{summary:"Task Name",has_due_date:"Has Due Date",is_all_day:"All Day",due_date:"Date",due_time:"Time",description:"Description",section_id:"Section",tags:"Tags",has_recurrence:"Recurring Task",recurrence_frequency:"Frequency",recurrence_interval:"Repeat Every",recurrence_byweekday:"Days of Week",recurrence_bymonthday:"Day of Month",points_value:`${e} Value`,streak_bonus_points:`Streak Bonus ${e}`,streak_bonus_interval:"Bonus Every X Days (0 = no bonus)"}[t.name]||t.name}}function Mt(t,e,o,s,i,a,r,n,d,c,l="Edit Task",h=!0){if(!t||!e)return j``;const p=function(t,e,o){const s=void 0!==t.has_due_date?t.has_due_date:!!t.due,i=void 0!==t.is_all_day&&t.is_all_day,a=[{name:"summary",required:!0,selector:{text:{}}},{name:"description",selector:{text:{multiline:!0}}}];if(e.length>0&&a.push({name:"section_id",selector:{select:{options:e.sort((t,e)=>e.sort_order-t.sort_order).map(t=>({label:t.name,value:t.id}))}}}),a.push({name:"tags",selector:{select:{multiple:!0,custom_value:!0,options:o.map(t=>({label:t,value:t}))}}}),a.push({name:"has_due_date",selector:{boolean:{}}}),s&&(a.push({name:"due_date",selector:{date:{}}}),i||a.push({name:"due_time",selector:{time:{}}}),a.push({name:"is_all_day",selector:{boolean:{}}})),s){const e=void 0!==t.has_recurrence&&t.has_recurrence,o=t.recurrence_frequency||"DAILY";a.push({name:"has_recurrence",selector:{boolean:{}}}),e&&(a.push({name:"recurrence_frequency",selector:{select:{options:[{label:"Daily",value:"DAILY"},{label:"Weekly",value:"WEEKLY"},{label:"Monthly",value:"MONTHLY"}]}}}),a.push({name:"recurrence_interval",selector:{number:{min:1,max:999,mode:"box"}}}),"WEEKLY"===o?a.push({name:"recurrence_byweekday",selector:{select:{multiple:!0,options:[{label:"Monday",value:"MO"},{label:"Tuesday",value:"TU"},{label:"Wednesday",value:"WE"},{label:"Thursday",value:"TH"},{label:"Friday",value:"FR"},{label:"Saturday",value:"SA"},{label:"Sunday",value:"SU"}]}}}):"MONTHLY"===o&&a.push({name:"recurrence_bymonthday",selector:{number:{min:1,max:31,mode:"box"}}}))}return a.push({name:"points_value",selector:{number:{min:0,max:1e4,mode:"box"}}}),s&&t.has_recurrence&&(a.push({name:"streak_bonus_points",selector:{number:{min:0,max:1e4,mode:"box"}}}),a.push({name:"streak_bonus_interval",selector:{number:{min:0,max:999,mode:"box"}}})),a}(e,s,i),u=function(t,e){const o=void 0!==t.has_due_date?t.has_due_date:!!t.due,s=void 0!==t.is_all_day&&t.is_all_day;let i=t.due_date||null,a=t.due_time||null;if(!i&&t.due){const e=_t(t.due);i=e.date,a=e.time}return{summary:t.summary||"",has_due_date:o,is_all_day:s,due_date:i||null,due_time:a||"00:00",description:t.description||"",section_id:t.section_id||(e.length>0?e.sort((t,e)=>e.sort_order-t.sort_order)[0].id:void 0),tags:t.tags||[],has_recurrence:o&&t.has_recurrence||!1,recurrence_frequency:t.recurrence_frequency||"DAILY",recurrence_interval:t.recurrence_interval||1,recurrence_byweekday:t.recurrence_byweekday||[],recurrence_bymonthday:t.recurrence_bymonthday||1,points_value:t.points_value||0,streak_bonus_points:t.streak_bonus_points||0,streak_bonus_interval:t.streak_bonus_interval||0}}(e,s),_=St(o);return j`
  ...
  `}function Dt(t,e){if(t.startsWith("var(")){const e=getComputedStyle(document.documentElement).getPropertyValue(t.slice(4,-1).trim());if(!e)return t;t=e.trim()}let o,s,i;if(t.startsWith("#")){const e=t.replace("#","");o=parseInt(e.substring(0,2),16),s=parseInt(e.substring(2,4),16),i=parseInt(e.substring(4,6),16)}else{if(!t.startsWith("rgb"))return t;{const e=t.match(/\d+/g);if(!e)return t;[o,s,i]=e.map(Number)}}o/=255,s/=255,i/=255;const a=Math.max(o,s,i),r=Math.min(o,s,i);let n=0,d=0,c=(a+r)/2;if(a!==r){const t=a-r;switch(d=c>.5?t/(2-a-r):t/(a+r),a){case o:n=((s-i)/t+(s<i?6:0))/6;break;case s:n=((i-o)/t+2)/6;break;case i:n=((o-s)/t+4)/6}}c=e>0?Math.max(0,Math.min(.95,c+e/100*(1-c))):Math.max(.05,c+e/100*c);const l=(t,e,o)=>(o<0&&(o+=1),o>1&&(o-=1),o<1/6?t+6*(e-t)*o:o<.5?e:o<2/3?t+(e-t)*(2/3-o)*6:t);let h,p,u;if(0===d)h=p=u=c;else{const t=c<.5?c*(1+d):c+d-c*d,e=2*c-t;h=l(e,t,n+1/3),p=l(e,t,n),u=l(e,t,n-1/3)}const _=t=>{const e=Math.round(255*t).toString(16);return 1===e.length?"0"+e:e};return`${_(h)}${_(p)}${_(u)}`.toUpperCase()}function Et(t){return{lighter:Dt(t,30),light:Dt(t,15),base:(e=t,e.startsWith("#")?e.substring(1).toUpperCase():/^[0-9A-Fa-f]{6}$/.test(e)?e.toUpperCase():Dt(e,0)),dark:Dt(t,-15),darker:Dt(t,-30)};var e}var Pt={};!function t(e,o,s,i){var a=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),r="function"==typeof Path2D&&"function"==typeof DOMMatrix,n=function(){if(!e.OffscreenCanvas)return!1;try{var t=new OffscreenCanvas(1,1),o=t.getContext("2d");o.fillRect(0,0,1,1);var s=t.transferToImageBitmap();o.createPattern(s,"no-repeat")}catch(t){return!1}return!0}();function d(){}function c(t){var s=o.exports.Promise,i=void 0!==s?s:e.Promise;return"function"==typeof i?new i(t):(t(d,d),null)}var l,h,p,u,_,g,f,m,b,w,v,y=(l=n,h=new Map,{transform:function(t){if(l)return t;if(h.has(t))return h.get(t);var e=new OffscreenCanvas(t.width,t.height);return e.getContext("2d").drawImage(t,0,0),h.set(t,e),e},clear:function(){h.clear()}}),k=(_=Math.floor(1e3/60),g={},f=0,"function"==typeof requestAnimationFrame&&"function"==typeof cancelAnimationFrame?(p=function(t){var e=Math.random();return g[e]=requestAnimationFrame(function o(s){f===s||f+_-1<s?(f=s,delete g[e],t()):g[e]=requestAnimationFrame(o)}),e},u=function(t){g[t]&&cancelAnimationFrame(g[t])}):(p=function(t){return setTimeout(t,_)},u=function(t){return clearTimeout(t)}),{frame:p,cancel:u}),x=(w={},function(){if(m)return m;if(!s&&a){var e=["var CONFETTI, SIZE = {}, module = {};","("+t.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join("\n");try{m=new Worker(URL.createObjectURL(new Blob([e])))}catch(t){return"undefined"!=typeof console&&"function"==typeof console.warn&&console.warn("🎊 Could not load worker",t),null}!function(t){function e(e,o){t.postMessage({options:e||{},callback:o})}t.init=function(e){var o=e.transferControlToOffscreen();t.postMessage({canvas:o},[o])},t.fire=function(o,s,i){if(b)return e(o,null),b;var a=Math.random().toString(36).slice(2);return b=c(function(s){function r(e){e.data.callback===a&&(delete w[a],t.removeEventListener("message",r),b=null,y.clear(),i(),s())}t.addEventListener("message",r),e(o,a),w[a]=r.bind(null,{data:{callback:a}})})},t.reset=function(){for(var e in t.postMessage({reset:!0}),w)w[e](),delete w[e]}}(m)}return m}),$={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function T(t,e,o){return function(t,e){return e?e(t):t}(t&&null!=t[e]?t[e]:$[e],o)}function C(t){return t<0?0:Math.floor(t)}function A(t,e){return Math.floor(Math.random()*(e-t))+t}function S(t){return parseInt(t,16)}function M(t){return t.map(D)}function D(t){var e=String(t).replace(/[^0-9a-f]/gi,"");return e.length<6&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),{r:S(e.substring(0,2)),g:S(e.substring(2,4)),b:S(e.substring(4,6))}}function E(t){t.width=document.documentElement.clientWidth,t.height=document.documentElement.clientHeight}function P(t){var e=t.getBoundingClientRect();t.width=e.width,t.height=e.height}function R(t){var e=t.angle*(Math.PI/180),o=t.spread*(Math.PI/180);return{x:t.x,y:t.y,wobble:10*Math.random(),wobbleSpeed:Math.min(.11,.1*Math.random()+.05),velocity:.5*t.startVelocity+Math.random()*t.startVelocity,angle2D:-e+(.5*o-Math.random()*o),tiltAngle:(.5*Math.random()+.25)*Math.PI,color:t.color,shape:t.shape,tick:0,totalTicks:t.ticks,decay:t.decay,drift:t.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:3*t.gravity,ovalScalar:.6,scalar:t.scalar,flat:t.flat}}function O(t,e){e.x+=Math.cos(e.angle2D)*e.velocity+e.drift,e.y+=Math.sin(e.angle2D)*e.velocity+e.gravity,e.velocity*=e.decay,e.flat?(e.wobble=0,e.wobbleX=e.x+10*e.scalar,e.wobbleY=e.y+10*e.scalar,e.tiltSin=0,e.tiltCos=0,e.random=1):(e.wobble+=e.wobbleSpeed,e.wobbleX=e.x+10*e.scalar*Math.cos(e.wobble),e.wobbleY=e.y+10*e.scalar*Math.sin(e.wobble),e.tiltAngle+=.1,e.tiltSin=Math.sin(e.tiltAngle),e.tiltCos=Math.cos(e.tiltAngle),e.random=Math.random()+2);var o=e.tick++/e.totalTicks,s=e.x+e.random*e.tiltCos,i=e.y+e.random*e.tiltSin,a=e.wobbleX+e.random*e.tiltCos,n=e.wobbleY+e.random*e.tiltSin;if(t.fillStyle="rgba("+e.color.r+", "+e.color.g+", "+e.color.b+", "+(1-o)+")",t.beginPath(),r&&"path"===e.shape.type&&"string"==typeof e.shape.path&&Array.isArray(e.shape.matrix))t.fill(function(t,e,o,s,i,a,r){var n=new Path2D(t),d=new Path2D;d.addPath(n,new DOMMatrix(e));var c=new Path2D;return c.addPath(d,new DOMMatrix([Math.cos(r)*i,Math.sin(r)*i,-Math.sin(r)*a,Math.cos(r)*a,o,s])),c}(e.shape.path,e.shape.matrix,e.x,e.y,.1*Math.abs(a-s),.1*Math.abs(n-i),Math.PI/10*e.wobble));else if("bitmap"===e.shape.type){var d=Math.PI/10*e.wobble,c=.1*Math.abs(a-s),l=.1*Math.abs(n-i),h=e.shape.bitmap.width*e.scalar,p=e.shape.bitmap.height*e.scalar,u=new DOMMatrix([Math.cos(d)*c,Math.sin(d)*c,-Math.sin(d)*l,Math.cos(d)*l,e.x,e.y]);u.multiplySelf(new DOMMatrix(e.shape.matrix));var _=t.createPattern(y.transform(e.shape.bitmap),"no-repeat");_.setTransform(u),t.globalAlpha=1-o,t.fillStyle=_,t.fillRect(e.x-h/2,e.y-p/2,h,p),t.globalAlpha=1}else if("circle"===e.shape)t.ellipse?t.ellipse(e.x,e.y,Math.abs(a-s)*e.ovalScalar,Math.abs(n-i)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI):function(t,e,o,s,i,a,r,n,d){t.save(),t.translate(e,o),t.rotate(a),t.scale(s,i),t.arc(0,0,1,r,n,d),t.restore()}(t,e.x,e.y,Math.abs(a-s)*e.ovalScalar,Math.abs(n-i)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI);else if("star"===e.shape)for(var g=Math.PI/2*3,f=4*e.scalar,m=8*e.scalar,b=e.x,w=e.y,v=5,k=Math.PI/v;v--;)b=e.x+Math.cos(g)*m,w=e.y+Math.sin(g)*m,t.lineTo(b,w),g+=k,b=e.x+Math.cos(g)*f,w=e.y+Math.sin(g)*f,t.lineTo(b,w),g+=k;else t.moveTo(Math.floor(e.x),Math.floor(e.y)),t.lineTo(Math.floor(e.wobbleX),Math.floor(i)),t.lineTo(Math.floor(a),Math.floor(n)),t.lineTo(Math.floor(s),Math.floor(e.wobbleY));return t.closePath(),t.fill(),e.tick<e.totalTicks}function z(t,o){var r,n=!t,d=!!T(o||{},"resize"),l=!1,h=T(o,"disableForReducedMotion",Boolean),p=a&&!!T(o||{},"useWorker")?x():null,u=n?E:P,_=!(!t||!p)&&!!t.__confetti_initialized,g="function"==typeof matchMedia&&matchMedia("(prefers-reduced-motion)").matches;function f(e,o,a){for(var n=T(e,"particleCount",C),d=T(e,"angle",Number),l=T(e,"spread",Number),h=T(e,"startVelocity",Number),p=T(e,"decay",Number),_=T(e,"gravity",Number),g=T(e,"drift",Number),f=T(e,"colors",M),m=T(e,"ticks",Number),b=T(e,"shapes"),w=T(e,"scalar"),v=!!T(e,"flat"),x=function(t){var e=T(t,"origin",Object);return e.x=T(e,"x",Number),e.y=T(e,"y",Number),e}(e),$=n,S=[],D=t.width*x.x,E=t.height*x.y;$--;)S.push(R({x:D,y:E,angle:d,spread:l,startVelocity:h,color:f[$%f.length],shape:b[A(0,b.length)],ticks:m,decay:p,gravity:_,drift:g,scalar:w,flat:v}));return r?r.addFettis(S):(r=function(t,e,o,a,r){var n,d,l=e.slice(),h=t.getContext("2d"),p=c(function(e){function c(){n=d=null,h.clearRect(0,0,a.width,a.height),y.clear(),r(),e()}n=k.frame(function e(){!s||a.width===i.width&&a.height===i.height||(a.width=t.width=i.width,a.height=t.height=i.height),a.width||a.height||(o(t),a.width=t.width,a.height=t.height),h.clearRect(0,0,a.width,a.height),(l=l.filter(function(t){return O(h,t)})).length?n=k.frame(e):c()}),d=c});return{addFettis:function(t){return l=l.concat(t),p},canvas:t,promise:p,reset:function(){n&&k.cancel(n),d&&d()}}}(t,S,u,o,a),r.promise)}function m(o){var s=h||T(o,"disableForReducedMotion",Boolean),i=T(o,"zIndex",Number);if(s&&g)return c(function(t){t()});n&&r?t=r.canvas:n&&!t&&(t=function(t){var e=document.createElement("canvas");return e.style.position="fixed",e.style.top="0px",e.style.left="0px",e.style.pointerEvents="none",e.style.zIndex=t,e}(i),document.body.appendChild(t)),d&&!_&&u(t);var a={width:t.width,height:t.height};function m(){if(p){var e={getBoundingClientRect:function(){if(!n)return t.getBoundingClientRect()}};return u(e),void p.postMessage({resize:{width:e.width,height:e.height}})}a.width=a.height=null}function b(){r=null,d&&(l=!1,e.removeEventListener("resize",m)),n&&t&&(document.body.contains(t)&&document.body.removeChild(t),t=null,_=!1)}return p&&!_&&p.init(t),_=!0,p&&(t.__confetti_initialized=!0),d&&!l&&(l=!0,e.addEventListener("resize",m,!1)),p?p.fire(o,a,b):f(o,a,b)}return m.reset=function(){p&&p.reset(),r&&r.reset()},m}function B(){return v||(v=z(null,{useWorker:!0,resize:!0})),v}o.exports=function(){return B().apply(this,arguments)},o.exports.reset=function(){B().reset()},o.exports.create=z,o.exports.shapeFromPath=function(t){if(!r)throw new Error("path confetti are not supported in this browser");var e,o;"string"==typeof t?e=t:(e=t.path,o=t.matrix);var s=new Path2D(e),i=document.createElement("canvas").getContext("2d");if(!o){for(var a,n,d=1e3,c=d,l=d,h=0,p=0,u=0;u<d;u+=2)for(var _=0;_<d;_+=2)i.isPointInPath(s,u,_,"nonzero")&&(c=Math.min(c,u),l=Math.min(l,_),h=Math.max(h,u),p=Math.max(p,_));a=h-c,n=p-l;var g=Math.min(10/a,10/n);o=[g,0,0,g,-Math.round(a/2+c)*g,-Math.round(n/2+l)*g]}return{type:"path",path:e,matrix:o}},o.exports.shapeFromText=function(t){var e,o=1,s="#000000",i='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';"string"==typeof t?e=t:(e=t.text,o="scalar"in t?t.scalar:o,i="fontFamily"in t?t.fontFamily:i,s="color"in t?t.color:s);var a=10*o,r=a+"px "+i,n=new OffscreenCanvas(a,a),d=n.getContext("2d");d.font=r;var c=d.measureText(e),l=Math.ceil(c.actualBoundingBoxRight+c.actualBoundingBoxLeft),h=Math.ceil(c.actualBoundingBoxAscent+c.actualBoundingBoxDescent),p=c.actualBoundingBoxLeft+2,u=c.actualBoundingBoxAscent+2;l+=4,h+=4,(d=(n=new OffscreenCanvas(l,h)).getContext("2d")).font=r,d.fillStyle=s,d.fillText(e,p,u);var _=1/o;return{type:"bitmap",bitmap:n.transferToImageBitmap(),matrix:[_,0,0,_,-l*_/2,-h*_/2]}}}(function(){return"undefined"!=typeof window?window:"undefined"!=typeof self?self:this||{}}(),Pt,!1);var Rt=Pt.exports;function Ot(t,e){Rt({particleCount:30,spread:70,startVelocity:25,origin:t,colors:e,disableForReducedMotion:!0})}function zt(t,e=3e3){const o=Date.now()+e,s={startVelocity:30,spread:360,ticks:60,zIndex:0};function i(t,e){return Math.random()*(e-t)+t}const a=setInterval(function(){const r=o-Date.now();if(r<=0)return clearInterval(a);const n=r/e*50;Rt({...s,particleCount:n,origin:{x:i(.1,.3),y:Math.random()-.2},colors:t,disableForReducedMotion:!0}),Rt({...s,particleCount:n,origin:{x:i(.7,.9),y:Math.random()-.2},colors:t,disableForReducedMotion:!0})},250)}function Bt(t,e=5e3){const o=Date.now()+e;function s(t,e){return Math.random()*(e-t)+t}!function i(){const a=o-Date.now(),r=Math.max(200,a/e*500);Rt({particleCount:1,startVelocity:0,ticks:r,origin:{x:Math.random(),y:.3*Math.random()-.1},colors:t,shapes:["star"],gravity:s(1.2,1.5),scalar:s(1.2,2),drift:s(-.4,.4),disableForReducedMotion:!0}),a>0&&requestAnimationFrame(i)}()}Pt.exports.create;let Ut=class extends nt{constructor(){super(...arguments),this._editDialogOpen=!1,this._editingTask=null,this._saving=!1,this._groups=[],this._addTaskDialogOpen=!1,this._newTask=null,this._savingNewTask=!1,this._autoCollapseTimeouts=new Map,this._previousGroupProgress=new Map,this.shades={lighter:"",light:"",base:"",dark:"",darker:""},this.shadesArray=[]}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config={entity:t.entity,title:t.title||"Tasks",show_title:!1!==t.show_title,show_dateless_tasks:!1!==t.show_dateless_tasks,hide_card_background:!0===t.hide_card_background,accent_color:t.accent_color||"",task_text_color:t.task_text_color||"",show_points:!1!==t.show_points,untagged_header:t.untagged_header||"Untagged",tag_group_order:t.tag_group_order||[],show_future_tasks:!0===t.show_future_tasks,filter_section_id:t.filter_section_id,person_entity:t.person_entity,show_add_task_button:!1!==t.show_add_task_button}}getCardSize(){return 3}willUpdate(t){if((t.has("_config")||t.has("hass"))&&this._config&&this.hass){let t="var(--primary-color)";if(this._config.person_entity){const e=this.hass.states["sensor.chorebot_points"],o=(e?.attributes.people||{})[this._config.person_entity];o?.accent_color&&(t=o.accent_color)}this._config.accent_color&&(t=this._config.accent_color),this.shades=Et(t),this.shadesArray=Object.values(this.shades)}(t.has("hass")||t.has("_config"))&&this._updateGroups()}_updateGroups(){if(!this.hass||!this._config)return;const t=this.hass.states[this._config.entity];if(!t)return;let e=xt(t,!1!==this._config.show_dateless_tasks,!0===this._config.show_future_tasks,this._config.untagged_header||"Untagged","Upcoming",this._config.filter_section_id,this._config.person_entity);e=yt(e,this._config.tag_group_order,this._config.untagged_header,"Upcoming"),this._groups=e.map(t=>({...t,isCollapsed:this._findExistingCollapseState(t.name)}))}_findExistingCollapseState(t){const e=this._groups.find(e=>e.name===t);return void 0!==e?e.isCollapsed:"Upcoming"===t}render(){if(!this.hass||!this._config)return j`<ha-card>Loading...</ha-card>`;return this.hass.states[this._config.entity]?j`
    ...
    `:j`<ha-card>
      ...
      `})}_renderPointsBadge(t){if(!this._config?.show_points||!t.points_value)return j``;const e=this._config.task_text_color||"white",o=Tt(this.hass),s=this.hass?.states[this._config.entity],i=s?.attributes.chorebot_templates||[];if(t.parent_uid){const s=i.find(e=>e.uid===t.parent_uid);if(s&&s.streak_bonus_points&&s.streak_bonus_interval){if((s.streak_current+1)%s.streak_bonus_interval===0)return j`<span
  ...
  `}function Nt(t,e,o){const s=Tt(e);return j`
    <div class="person-points" style="color: ${o}">
      ${t.points_balance}
      ${s.icon?j`<ha-icon icon="${s.icon}"></ha-icon>`:""}
      ${s.text?s.text:""}
    </div>
  `}function Ht(t,e){const o=t.states[e];return o?.attributes.friendly_name||e.replace("person.","")}function Lt(t,e){const o=t.states["sensor.chorebot_points"];if(!o)return;return(o.attributes.people||{})[e]}function jt(t){const e=t.states["sensor.chorebot_points"];if(!e)return[];const o=e.attributes.people||{};return Object.values(o)}It.styles=r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `,t([pt({attribute:!1})],It.prototype,"hass",void 0),t([ut()],It.prototype,"_config",void 0),t([ut()],It.prototype,"_dialogOpen",void 0),t([ut()],It.prototype,"_newTask",void 0),t([ut()],It.prototype,"_saving",void 0),It=t([ct("chorebot-add-task-card")],It),window.customCards=window.customCards||[],window.customCards.push({type:"chorebot-add-task-card",name:"ChoreBot Add Task Card",description:"A button card for quickly adding new ChoreBot tasks",preview:!0}),console.info("%c CHOREBOT-ADD-TASK-CARD %c v0.1.0 ","color: white; background: #4CAF50; font-weight: bold;","color: #4CAF50; background: white; font-weight: bold;");let Yt=class extends nt{constructor(){super(...arguments),this.shades={lighter:"",light:"",base:"",dark:"",darker:""}}setConfig(t){if(!t.person_entity)throw new Error("person_entity is required");this._config={type:"custom:chorebot-person-points-card",person_entity:t.person_entity,title:t.title||"Points",show_title:!1!==t.show_title,hide_card_background:!0===t.hide_card_background,show_progress:!1!==t.show_progress,accent_color:t.accent_color||"",progress_text_color:t.progress_text_color||""}}willUpdate(t){if(super.willUpdate(t),(t.has("_config")||t.has("hass"))&&this._config&&this.hass){let t="var(--primary-color)";if(this._config.person_entity){const e=this.hass.states["sensor.chorebot_points"],o=(e?.attributes.people||{})[this._config.person_entity];o?.accent_color&&(t=o.accent_color)}this._config.accent_color&&(t=this._config.accent_color),this.shades=Et(t)}(t.has("hass")||t.has("_config"))&&this.hass&&this._config&&(this._progress=this._calculatePersonProgress())}_calculatePersonProgress(){if(!this.hass||!this._config)return{completed:0,total:0};const t=Object.values(this.hass.states).filter(t=>t.entity_id.startsWith("todo.")),e=t.filter(t=>t.entity_id.startsWith("todo.chorebot_"));return vt(kt(e,this._config.person_entity,!1))}static getStubConfig(){return{type:"custom:chorebot-person-points-card",person_entity:"",title:"Points",show_title:!0,hide_card_background:!1,show_progress:!0,accent_color:"",progress_text_color:""}}static getConfigForm(){return{schema:[{name:"person_entity",required:!0,selector:{entity:{filter:{domain:"person"}}}},{name:"title",default:"Points",selector:{text:{}}},{name:"show_title",default:!0,selector:{boolean:{}}},{name:"hide_card_background",default:!1,selector:{boolean:{}}},{name:"show_progress",default:!0,selector:{boolean:{}}},{name:"accent_color",selector:{text:{}}},{name:"progress_text_color",selector:{text:{}}}],computeLabel:t=>({person_entity:"Person Entity",title:"Card Title",show_title:"Show Title",hide_card_background:"Hide Card Background",show_progress:"Show Progress Bar",accent_color:"Accent Color",progress_text_color:"Progress Text Color"}[t.name]||void 0),computeHelper:t=>({person_entity:"Select the person entity to display points for",title:"Custom title for the card",show_title:"Show the card title",hide_card_background:"Hide the card background and padding for a seamless look",show_progress:"Display task completion progress below the person's name",accent_color:"Accent color for progress bar and points text (hex code or CSS variable like var(--primary-color))",progress_text_color:"Text color for progress label (hex code or CSS variable)"}[t.name]||void 0)}}getCardSize(){return 1}render(){if(!this.hass||!this._config)return j``;const t=this.hass.states["sensor.chorebot_points"];if(!t)return j`<ha-card>
    ...
    `:j`<ha-card>
      ...
      </ha-card>`}_renderPersonDisplay(t,e){const o=Ht(this.hass,this._config.person_entity);return j`
      <div class="person-container">
        <div class="person-left">
          ${Ft(this.hass,this._config.person_entity,0,64)}
        </div>
        <div class="person-info">
          <div class="person-header">
            <div class="person-name">${o}</div>
            ${Nt(e,this.hass,`#${this.shades.base}`)}
          </div>
  ...
  `,t([pt({attribute:!1})],Yt.prototype,"hass",void 0),t([ut()],Yt.prototype,"_config",void 0),t([ut()],Yt.prototype,"_progress",void 0),Yt=t([ct("chorebot-person-points-card")],Yt),window.customCards=window.customCards||[],window.customCards.push({type:"chorebot-person-points-card",name:"ChoreBot Person Points Card",description:"Display a person's avatar and points balance",preview:!0}),console.info("%c CHOREBOT-PERSON-POINTS-CARD %c v0.1.0 ","color: white; background: #FF9800; font-weight: bold;","color: #FF9800; background: white; font-weight: bold;");let qt=class extends nt{constructor(){super(...arguments),this._redeeming=null,this._showConfirmModal=!1,this._showAddRewardModal=!1,this._pendingRedemption=null,this._rewardFormData={name:"",cost:50,icon:"mdi:gift",description:""},this._showEditRewardModal=!1,this._editingRewardId=null,this._rewardFormSchema=[{name:"name",required:!0,selector:{text:{}}},{name:"cost",selector:{number:{min:1,max:1e4,mode:"box"}}},{name:"icon",selector:{icon:{}}},{name:"description",selector:{text:{multiline:!0}}}],this._computeRewardFieldLabel=t=>{const e=Ct(this.hass);return{name:"Name",cost:`Cost (${e.charAt(0).toUpperCase()+e.slice(1)})`,icon:"Icon",description:"Description (Optional)"}[t.name]||t.name},this._computeRewardFieldHelper=t=>({cost:`Cost between 1 and 10,000 ${Ct(this.hass)}`,icon:"Use Material Design Icons (e.g., mdi:gift, mdi:ice-cream)"}[t.name]||""),this._handleRewardFormChange=t=>{this._rewardFormData=t.detail.value}}setConfig(t){if(!t.person_entity)throw new Error("person_entity is required");this._config={type:"custom:chorebot-person-rewards-card",person_entity:t.person_entity,title:t.title||void 0,show_title:!1!==t.show_title,hide_card_background:!0===t.hide_card_background,show_disabled_rewards:!0===t.show_disabled_rewards,sort_by:t.sort_by||"cost",show_add_reward_button:!1!==t.show_add_reward_button,accent_color:t.accent_color||""}}static getStubConfig(){return{type:"custom:chorebot-person-rewards-card",person_entity:"person.example",title:"My Rewards",show_title:!0,hide_card_background:!1,show_disabled_rewards:!1,sort_by:"cost",show_add_reward_button:!0,accent_color:""}}getCardSize(){return 3}static getConfigForm(){return{schema:[{name:"person_entity",required:!0,selector:{entity:{domain:"person"}}},{name:"title",selector:{text:{}}},{name:"show_title",default:!0,selector:{boolean:{}}},{name:"hide_card_background",default:!1,selector:{boolean:{}}},{name:"show_disabled_rewards",default:!1,selector:{boolean:{}}},{name:"sort_by",default:"cost",selector:{select:{options:[{label:"Cost (Low to High)",value:"cost"},{label:"Name (A-Z)",value:"name"},{label:"Date Created (Oldest First)",value:"created"}]}}},{name:"show_add_reward_button",default:!0,selector:{boolean:{}}},{name:"accent_color",selector:{text:{}}}],computeLabel:t=>({person_entity:"Person Entity",title:"Card Title",show_title:"Show Title",hide_card_background:"Hide Card Background",show_disabled_rewards:"Show Disabled Rewards",sort_by:"Sort Rewards By",show_add_reward_button:"Show Add Reward Button",accent_color:"Accent Color"}[t.name]||void 0),computeHelper:t=>({person_entity:"Select the person whose rewards to display",title:'Custom title for the card (defaults to "{Person Name}\'s Rewards")',show_title:"Show the card title",hide_card_background:"Hide the card background and padding for a seamless look",show_disabled_rewards:"Include rewards that have been disabled in the grid",sort_by:"Choose how to sort the rewards in the grid",show_add_reward_button:"Show the 'Add Reward' card for creating new rewards",accent_color:"Accent color for reward icons and buttons (hex code or CSS variable like var(--primary-color))"}[t.name]||void 0)}}render(){if(!this.hass||!this._config)return j`<ha-card>Loading...</ha-card>`;if(!this.hass.states[this._config.person_entity])return j`<ha-card>
      ...
      </ha-card>`;const e=t.attributes.people||{},o=t.attributes.rewards||[];let s="var(--primary-color)";if(this._config.person_entity){const t=e[this._config.person_entity];t?.accent_color&&(s=t.accent_color)}this._config.accent_color&&(s=this._config.accent_color),this.style.setProperty("--accent-color",s);const i=Ht(this.hass,this._config.person_entity),a=this._config.title||`${i}'s Rewards`;return j`
      <ha-card
        class="${this._config.hide_card_background?"no-background":""}"
      >
    ...
    `}_renderConfirmModal(t,e){if(!this._pendingRedemption||!this._config)return"";const{personId:o,rewardId:s}=this._pendingRedemption,i=t[o],a=e.find(t=>t.id===s);if(!i||!a)return"";const r=Ht(this.hass,o),n=i.points_balance-a.cost,d=i.points_balance>=a.cost,c=a.enabled&&d,l=Tt(this.hass);return j`
  ...
  `,t([pt({attribute:!1})],qt.prototype,"hass",void 0),t([ut()],qt.prototype,"_config",void 0),t([ut()],qt.prototype,"_redeeming",void 0),t([ut()],qt.prototype,"_showConfirmModal",void 0),t([ut()],qt.prototype,"_showAddRewardModal",void 0),t([ut()],qt.prototype,"_pendingRedemption",void 0),t([ut()],qt.prototype,"_rewardFormData",void 0),t([ut()],qt.prototype,"_showEditRewardModal",void 0),t([ut()],qt.prototype,"_editingRewardId",void 0),qt=t([ct("chorebot-person-rewards-card")],qt),window.customCards=window.customCards||[],window.customCards.push({type:"chorebot-person-rewards-card",name:"ChoreBot Person Rewards Card",description:"Display person-specific rewards with inline creation and redemption",preview:!0}),console.info("%c CHOREBOT-PERSON-REWARDS-CARD %c v0.1.0 ","color: white; background: #9C27B0; font-weight: bold;","color: #9C27B0; background: white; font-weight: bold;");let Wt=class extends nt{constructor(){super(...arguments),this._selectedPersonId="",this._dropdownOpen=!1,this._groups=[],this._editDialogOpen=!1,this._editingTask=null,this._saving=!1,this.shades={lighter:"",light:"",base:"",dark:"",darker:""},this.shadesArray=[]}setConfig(t){if(!t.entity)throw new Error("You must specify an entity (todo list)");if(!t.entity.startsWith("todo."))throw new Error("Entity must be a todo list (todo.*)");this._config={show_title:!0,show_progress:!0,show_dateless_tasks:!0,show_future_tasks:!1,show_points:!0,show_add_task_button:!0,show_all_people:!1,hide_person_background:!1,hide_tasks_background:!1,untagged_header:"Untagged",...t}}static getStubConfig(){return{type:"custom:chorebot-person-grouped-card",entity:"",default_person_entity:"",show_all_people:!1,show_progress:!0,show_title:!0,hide_person_background:!1,hide_tasks_background:!1,accent_color:"",show_dateless_tasks:!0,show_future_tasks:!1,show_points:!0,show_add_task_button:!0,untagged_header:"Untagged",tag_group_order:[],filter_section_id:""}}static getConfigForm(){return{schema:[{name:"entity",required:!0,selector:{entity:{filter:{domain:"todo"}}}},{name:"default_person_entity",selector:{entity:{filter:{domain:"person"}}}},{name:"show_all_people",default:!1,selector:{boolean:{}}},{name:"show_progress",default:!0,selector:{boolean:{}}},{name:"show_title",default:!0,selector:{boolean:{}}},{name:"show_dateless_tasks",default:!0,selector:{boolean:{}}},{name:"show_future_tasks",default:!1,selector:{boolean:{}}},{name:"show_points",default:!0,selector:{boolean:{}}},{name:"show_add_task_button",default:!0,selector:{boolean:{}}},{name:"filter_section_id",selector:{text:{}}},{name:"hide_person_background",default:!1,selector:{boolean:{}}},{name:"hide_tasks_background",default:!1,selector:{boolean:{}}},{name:"accent_color",selector:{text:{}}},{name:"task_text_color",selector:{text:{}}},{name:"progress_text_color",selector:{text:{}}},{name:"untagged_header",default:"Untagged",selector:{text:{}}},{name:"tag_group_order",selector:{select:{multiple:!0,custom_value:!0,options:[]}}}],computeLabel:t=>({entity:"Todo Entity",default_person_entity:"Default Person",show_all_people:"Show All People",show_progress:"Show Progress Bar",show_title:"Show Title",show_dateless_tasks:"Show Tasks Without Due Date",show_future_tasks:"Show Future Tasks",show_points:"Show Points Badges",show_add_task_button:"Show Add Task Button",filter_section_id:"Filter by Section",hide_person_background:"Hide Person Background",hide_tasks_background:"Hide Tasks Background",accent_color:"Accent Color",task_text_color:"Task Text Color",progress_text_color:"Progress Text Color",untagged_header:"Untagged Tasks Header",tag_group_order:"Tag Display Order"}[t.name]||void 0),computeHelper:t=>({entity:"Select the ChoreBot todo entity to display",default_person_entity:"Override auto-detected person. Leave empty to auto-detect logged-in user or use first person alphabetically.",show_all_people:"Show all people in dropdown, or only people with tasks in this list",show_progress:"Display progress bar showing completed/total tasks for selected person",show_title:"Show the person's name as card title",show_dateless_tasks:"Show tasks that do not have a due date",show_future_tasks:"Show tasks with future due dates in a collapsible 'Upcoming' section (collapsed by default)",show_points:"Display points badges on task items",show_add_task_button:"Show the 'Add Task' button below tag groups for creating new tasks",filter_section_id:'Additional section filter (e.g., "Morning Routine"). Leave empty to show all sections for selected person.',hide_person_background:"Hide the person section background and shadow for a seamless look",hide_tasks_background:"Hide the tasks section background and shadow for a seamless look",accent_color:"Override accent color for person display and tag headers (hex code or CSS variable). By default inherits from person's profile.",task_text_color:"Text color for task items (hex code or CSS variable)",progress_text_color:"Text color for progress label (hex code or CSS variable)",untagged_header:'Header text for tasks without tags (default: "Untagged")',tag_group_order:"Order to display tag groups. Tags not listed will appear alphabetically after these."}[t.name]||void 0)}}willUpdate(t){if(t.has("hass")&&""===this._selectedPersonId){let t=function(t){const e=t.user?.name;if(!e)return null;const o=Object.values(t.states).filter(t=>t.entity_id.startsWith("person.")),s=o.find(t=>t.attributes.friendly_name?.toLowerCase()===e.toLowerCase());return s?.entity_id||null}(this.hass);if(!t&&this._config.default_person_entity&&(t=this._config.default_person_entity),!t){const e=jt(this.hass);if(e.length>0){const o=e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id));t=o[0].entity_id}}this._selectedPersonId=t||""}if((t.has("_config")||t.has("_selectedPersonId"))&&this._config){const t=this._selectedPersonId?Lt(this.hass,this._selectedPersonId):null;let e="var(--primary-color)";t?.accent_color&&(e=t.accent_color),this._config.accent_color&&(e=this._config.accent_color),this.shades=Et(e),this.shadesArray=[this.shades.lighter,this.shades.light,this.shades.base,this.shades.dark,this.shades.darker]}(t.has("hass")||t.has("_config")||t.has("_selectedPersonId"))&&this._updateGroups()}render(){return this.hass&&this._config?this._selectedPersonId?j`
    ...
    `:j`
      ...
      `:j``}_renderPersonDisplay(){const t=this._selectedPersonId,e=t?Lt(this.hass,t):null;let o="var(--primary-color)";return e?.accent_color&&(o=e.accent_color),this._config.accent_color&&(o=this._config.accent_color),j`
      <div 
        class="person-header"
        ...
        <div class="person-container">
          ...
          <div class="person-info">
            <div class="person-header-row">
              <div class="person-name">${Ht(this.hass,t)}</div>
    ...
    `}_getAvailablePeople(){const t=jt(this.hass);if(this._config.show_all_people)return t;const e=this.hass?.states[this._config.entity],o=e?.attributes.chorebot_tasks||[],s=new Set;for(const t of o)t.computed_person_id&&s.add(t.computed_person_id);return t.filter(t=>s.has(t.entity_id))}_renderProgressBar(){const t=Object.values(this.hass.states).filter(t=>t.entity_id.startsWith("todo.chorebot_")),e=vt(kt(t,this._selectedPersonId,!1)),o=e.total>0?e.completed/e.total*100:0,s=this._config?.progress_text_color||"var(--text-primary-color)";return j`
      <div
        class="progress-bar"
        style="background: #${this.shades.lighter}"
        aria-label="${e.completed} of ${e.total} tasks completed"
      >
        <div
          class="progress-bar-fill"
          style="width: ${o}%; background: #${this.shades.darker}"
        ></div>
        <div class="progress-text" style="color: ${s}">
          ${e.completed}/${e.total}
        </div>
      </div>
    `}_toggleDropdown(){this._dropdownOpen=!this._dropdownOpen}_selectPerson(t){this._selectedPersonId=t,this._dropdownOpen=!1}_updateGroups(){if(!this.hass||!this._config)return;const t=this.hass.states[this._config.entity];if(!t)return;let e=xt(t,!1!==this._config.show_dateless_tasks,!0===this._config.show_future_tasks,this._config.untagged_header||"Untagged","Upcoming",this._config.filter_section_id,this._selectedPersonId);e=yt(e,this._config.tag_group_order,this._config.untagged_header,"Upcoming"),this._groups=e.map(t=>({...t,isCollapsed:this._findExistingCollapseState(t.name)}))}_findExistingCollapseState(t){const e=this._groups.find(e=>e.name===t);return void 0!==e?e.isCollapsed:"Upcoming"===t}_renderGroupedTasks(){return 0===this._groups.length?j`<div class="empty-state">No tasks for this person</div>`:j`
    ...
    >
      ...
      ${o.icon?j`<ha-icon icon="${o.icon}"></ha-icon>`:""}
      ${o.text?o.text:""}
    </span>`}_renderAddTaskButton(){if(!this._config?.show_add_task_button)return j``;const t=`#${this.shades.light}`,e=`color-mix(in srgb, #${this.shades.light} 20%, var(--card-background-color))`,o=`#${this.shades.light}`;return j`
      <div
        class="add-task-button-container"
        style="--button-border-color: ${t}; --button-hover-bg: ${e}; --button-hover-color: ${o};"
      >
    ...
    `}_toggleGroup(t){const e=this._groups.find(e=>e.name===t);e&&(e.isCollapsed=!e.isCollapsed,this.requestUpdate())}async _toggleTask(t,e){const o="completed"===t.status?"needs_action":"completed";await this.hass.callService("todo","update_item",{entity_id:this._config.entity,item:t.uid,status:o}),"completed"===o&&e&&Ot(e,this.shadesArray)}_handleCompletionClick(t,e){t.stopPropagation();const o=t.currentTarget.getBoundingClientRect(),s={x:(o.left+o.width/2)/window.innerWidth,y:(o.top+o.height/2)/window.innerHeight};this._toggleTask(e,s)}_openEditDialog(t){if(!this.hass||!this._config?.entity)return;const e=this.hass.states[this._config.entity];if(!e)return;const o=e.attributes.chorebot_templates||[];this._editingTask=At(t,o),this._editDialogOpen=!0}_closeEditDialog(){this._editDialogOpen=!1,this._editingTask=null}_renderEditDialog(){const t=this.hass?.states[this._config.entity],e=t?.attributes.chorebot_sections||[],o=t?.attributes.chorebot_tags||[];return Mt(this._editDialogOpen,this._editingTask,this.hass,e,o,this._saving,()=>this._closeEditDialog(),t=>this._formValueChanged(t),()=>this._saveTask(),()=>this._handleDeleteTask())}_formValueChanged(t){const e=t.detail.value;this._editingTask={...this._editingTask,...e},("has_due_date"in e||"is_all_day"in e||"has_recurrence"in e||"recurrence_frequency"in e)&&this.requestUpdate()}async _saveTask(){if(!this._editingTask||!this._editingTask.summary?.trim()||this._saving)return;this._saving=!0;const t={list_id:this._config.entity,uid:this._editingTask.uid,summary:this._editingTask.summary.trim()};if(this._editingTask.has_due_date&&this._editingTask.due_date){const e=!!this._editingTask.is_all_day;let o;if(e||!this._editingTask.due_time)o=`${this._editingTask.due_date}T00:00:00`;else{const t=3===this._editingTask.due_time.split(":").length?this._editingTask.due_time:`${this._editingTask.due_time}:00`;o=`${this._editingTask.due_date}T${t}`}const s=new Date(o);if(isNaN(s.getTime()))return console.error("Invalid date/time combination:",o),void(this._saving=!1);t.due=s.toISOString(),t.is_all_day=e}else!1===this._editingTask.has_due_date&&(t.due="",t.is_all_day=!1);this._editingTask.description&&(t.description=this._editingTask.description),this._editingTask.section_id&&(t.section_id=this._editingTask.section_id),void 0!==this._editingTask.tags&&(t.tags=this._editingTask.tags);const e=$t(this._editingTask);null!==e?t.rrule=e:!1===this._editingTask.has_recurrence&&(t.rrule=""),void 0!==this._editingTask.points_value&&(t.points_value=this._editingTask.points_value),void 0!==this._editingTask.streak_bonus_points&&(t.streak_bonus_points=this._editingTask.streak_bonus_points),void 0!==this._editingTask.streak_bonus_interval&&(t.streak_bonus_interval=this._editingTask.streak_bonus_interval);!!this._editingTask.parent_uid&&(t.include_future_occurrences=!0);try{await this.hass.callService("chorebot","update_task",t),this._closeEditDialog()}catch(t){console.error("Error saving task:",t),alert("Failed to save task. Please try again.")}finally{this._saving=!1}}async _handleDeleteTask(){if(!this._editingTask||this._saving)return;const t=this._editingTask,e=t.has_recurrence||t.parent_uid;if(confirm(e?"Delete this recurring task? This will remove all future occurrences, but keep completed instances.":"Delete this task? This action cannot be undone.")){this._saving=!0;try{await this.hass.callService("todo","remove_item",{entity_id:this._config.entity,item:t.uid}),this._closeEditDialog()}catch(t){console.error("Error deleting task:",t),alert(`Failed to delete task: ${t}`)}finally{this._saving=!1}}}_openAddTaskDialog(){const t=this.hass?.states[this._config.entity],e=t?.attributes.chorebot_sections||[];this._editingTask=this._createBlankTask(e),this._editDialogOpen=!0}_createBlankTask(t){let e;if(this._config.filter_section_id){let o=t.find(t=>t.id===this._config.filter_section_id);o||(o=t.find(t=>t.name.toLowerCase()===this._config.filter_section_id.toLowerCase())),o&&(e=o.id)}if(!e&&this._selectedPersonId){const o=t.find(t=>t.person_id===this._selectedPersonId);o&&(e=o.id)}return!e&&t.length>0&&(e=t.sort((t,e)=>e.sort_order-t.sort_order)[0].id),{uid:"",summary:"",status:"needs_action",has_due_date:!1,is_all_day:!1,due_date:void 0,due_time:void 0,description:"",section_id:e,tags:[],has_recurrence:!1,recurrence_frequency:"DAILY",recurrence_interval:1,recurrence_byweekday:[],recurrence_bymonthday:1,points_value:0,streak_bonus_points:0,streak_bonus_interval:0}}getCardSize(){return 3}};Wt.styles=r`
    :host {
      display: block;
    }
